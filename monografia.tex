...
A new set of filters was proposed by simplifying the DaWT original filters~\cite{DAUBTHESIS} in order to increase accurary of results. The algebraic manipulation of its filters made possible a gain in terms of accuracy of results in both 1D and 2D procedures. However there was a need to add normalization steps on the top of the original DaWT formulation which resulted in a loss of performance.
